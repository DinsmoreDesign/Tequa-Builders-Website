<?php 
    ...
    if (isset($_POST['submit']))
    {
        ...
        if (!preg_match("/^[1-9][0-9]{0,10}$/",$valid))
        {
            $error = true;
            $valid_error = "Please enter a valid number";
        }
        /*if($valid !== 5)
        {
            $error = true;
        ...
        {
            //send mail
            $toemail = "paintballthunder2000@gmail.com";
                ...
                <div class="col-sm-10 col-sm-offset-1">
                    <form role="form" class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="contactform">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="col-sm-2">
                                    <label for="txt_subject" class="control-label">Enter a number</label>
                                </div>
                                <div class="col-sm-10">
                                    <input class="form-control" name="txt_valid" placeholder="Your answer" type="text" value="<?php if($error) echo $valid; ?>" />
